declare const IVotingMachine_ABI: readonly [{
    ...
    readonly outputs: readonly [{
        readonly name: "";
        readonly type: "tuple";
        readonly internalType: "struct IVotingMachine.ProposalWithoutVotes";
    ...
    readonly outputs: readonly [{
        readonly name: "";
        readonly type: "uint8";
        readonly internalType: "enum IVotingMachine.ProposalState";
    }];
    readonly stateMutability: "view";
}, {
    readonly type: "function";
    ...
    readonly outputs: readonly [{
        readonly name: "";
        readonly type: "tuple";
        readonly internalType: "struct IVotingMachine.ProposalVoteConfiguration";
        readonly components: readonly [{
    ...
    readonly outputs: readonly [{
        readonly name: "";
        readonly type: "tuple";
        readonly internalType: "struct IVotingMachine.Vote";
        readonly components: readonly [{
    ...
    readonly inputs: readonly [{
        ...
        readonly type: "tuple[]";
        readonly internalType: "struct IVotingMachine.VotingBalanceProof[]";
        readonly components: readonly [{
    ...
    readonly inputs: readonly [{
        ...
        readonly type: "tuple";
        readonly internalType: "struct IVotingMachine.SignatureParams";
        readonly components: readonly [{
            readonly name: "v";
            readonly type: "uint8";
